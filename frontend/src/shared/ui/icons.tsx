...
/** Official ВТБ 2018 wordmark, adapted as an inline site asset. */
export function BrandMark({ size = 34, color, style }: IconProps) {
  const width = Math.round((size * 92) / 33);

  return (
    <svg
      viewBox="0 0 92 33"
      style={{ width, height: size, display: "block", ...style }}
      aria-hidden
    >
      <path
